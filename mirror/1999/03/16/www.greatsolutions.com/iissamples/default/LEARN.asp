...
<table border="0"
        cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td valign="top">
							<FONT size=2 face="Verdana, Arial, Helvetica">
		                       <b>The Windows NT 4.0 Option Pack includes:</b>
		                        <p class="p"> 
                       ...
                       <table border="0" cellpadding="5">
						...
						<td>
						<FONT size=2 face="Verdana, Arial, Helvetica">
						<li><B>Internet Information Server 4.0</b>, the standards-based,
			...
			of line-of-business applications.</li>
			<P>
													
			<li><b>Transaction Server 2.0</b> is a component-based
			...
			administration tool for managing enterprise applications.</li>
											
			<P>						
			<li><b>Index Server 2.0</b> indexes the contents
			...
			form formatted in HTML.</li>
											
			<P>
			<li><b>Certificate Server 1.0</b> is a general-purpose, highly customizable 
			...
			the Internet through the use of these certificates.</li>
			<P>						
			<li><b>Data Access Components 1.5</b>  consist of
			...
			components provide client/server applications&#151;deployed over the Web
			or a LAN&#151;with easy-to-use, programmatic access to all types of data
			throughout the enterprise.</li>
			<P>						
			<li><b>Site Server Express 2.0</b> offers a subset of the
			functionality found in Microsoft Site Server.  It includes site analysis,
			usage analysis and publishing capabilities.</li>
			<P>						
			<li><b>Message Queue (MSMQ) 1.0</b> makes it easy for
			...
			Windows&nbsp;95 and Windows&nbsp;NT.</li>
			<p>
			<li><b>Internet Connection Services</b> for Microsoft Remote Access Service 
			...
			costs, improve end-user experience, and enable new business paradigms over the Internet.</li>
			<P>	
			<li> <b> Administration</b> tools for many Option Pack components, such as IIS 
			...
			provides both Visual Basic&#174 Script and JScript scripting engines with WSH.
			</li>	
			<p>
			<li> <b> Development Components: </b>The SDK documentation with IIS 4.0 
			...
			written in Visual Basic Scripting Edition (VBScript), JScript&#153, and Java. 
			You can use Script Debugger to set breakpoints, step through scripts, view 
			and change values, and execute commands dynamically.</li>
			<p>				 
			<li> <b>Internet Explorer 4.0</b>,
...
<div align="center"><center>
        ...
        border="0" cellpadding="0" cellspacing="5">
            <tr>
                <td align="right"><a
                href="http://www.microsoft.com/ie"><img
                src="IE.GIF" alt="Download Internet Explorer!"
                border="0" width="88" height="31"></a></td>
                <td align="center">&nbsp;</td>
                <td><a href="http://www.microsoft.com/iis">
<img src="IISSide.GIF" alt="Learn more about Windows NT 4.0 Option Pack!" border=0></a></td>
            </tr>
        </table>
        ...
        border="0" cellpadding="0" cellspacing="5">
            <tr>
                ...
                face="Verdana, Arial, Helvetica">&#169;1997 Microsoft
                Corporation. All rights reserved. </font><a
                href="http://www.microsoft.com/misc/cpyright.htm"><font
                size="1" face="Verdana, Arial, Helvetica">Legal
                Notices.</font></a></td>
            </tr>
        </table>
        </center></div>
