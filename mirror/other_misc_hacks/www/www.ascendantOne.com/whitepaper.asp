<html>
<head>
<title> A s c e n d a n t O n e - Whitepaper </title>
...
<br><center> <img src="/images/whitepaperheading.gif"></center>
</center>
<!-- ******** body ********** -->
<div align="justify">
<h5>
<STRONG>AscendantOne</STRONG> is a new company -- fortified with solid,
established industry credentials -- positioned to design and implement fresh solutions for the
Property &amp; Casualty insurance industry.  AscendantOne's core enterprise includes constructing the
marketing and relationship avenues required by the fast changing needs of insurers and non-traditional risk-bearers as well as their customers.
</h5><h5>
AscendantOne is focused on building a suite of Internet and network-based automation solutions and
services that improve the business-to-business process of developing and maintaining Property
&amp; Casualty insurance contracts.  Solutions will also include business-to-customer interactions
where appropriate, to be primarily deployed by AscendantOne's business customers.
</h5><h5>

Built upon a unique and differentiated value proposition, and born of the shifting P&amp;C insurance
marketplace, AscendantOne is dedicated to being a trusted partner among P&amp;C insurers, helping to impact
the economics of bearing risk and enabling constructive interaction with divergent, demanding
client communities.  The company is also positioned to build fast, reliable and financially viable
capabilities for new entrants to the P&amp;C distribution system.  Most competitors assemble systems
using the "field of dreams" strategy: build a site and the insureds will come.  AscendantOne's channel
strategy provides a mechanism for carriers to pro-actively and engagingly interact with, as well as
transact with, key prospect market segments -- a significant channel philosophy differentiator
between AscendantOne and conventional vendors of P&amp;C solutions.
</h5>
</div>
<div align="right"><h3><a href="whitepaper1.asp"><img src="images/tonext.gif" border="0"></a></h3></div>
