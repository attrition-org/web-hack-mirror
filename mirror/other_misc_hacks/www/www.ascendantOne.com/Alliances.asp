<html>
<head>
<title> A s c e n d a n t O n e - Alliances </title>
...
<center><img src="/images/alliancesheading.gif">
</center>
<!-- ******** body ********** -->


<h5>Successful end-to-end technology solutions are often the result of creative collaboration among partners.  Each partner contributes valuable functional and technical perspectives, leading to tangible business solutions.  AscendantOne will continually develop alliances with best-of-breed solution providers.  A solid partnership strategy ensures on-going domain competence.  It also accelerates delivery of strategic insurance and financial services applications.  The company will especially seek partners who can expand whole solution benefits for front-end process management, contributing to the economic strength of our insurance and financial services customers.  
</h5>

<h5><table cellpadding="4" border="0" align="left"><tr><td><img src="images/bldg.jpg"></td></tr></table>

<div align="justify"> Although AscendantOne is a new business in the United States, a strategic partnership already exists with Canadian rating vendor Compu-Quote ( <a href="http://www.compu-quote.com" >www.compu-quote.com</a> Windsor, ON ) to provide rating technology.  Compu-Quote is the leading provider of Internet based quoting and policy issuance in Canada with a market share that exceeds 80%.  Its applications power several highly successful Internet based Canadian e-commerce sites.  AscendantOne has exclusive options to deploy Compu-Quote engines to develop a wide suite of insurance products/services quickly and reliably in the US.  Using an established partner's accumulated experience gives AscendantOne a distinct competitive advantage in the development and deployment of Internet/network-based insurance solutions.</div></h5>
