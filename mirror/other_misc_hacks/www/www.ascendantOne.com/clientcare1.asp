<html>
<head>
<title> A s c e n d a n t O n e  Client Care Mission</title>
...
<center><br><img src="/images/clientcaretitle.gif">
</center>
<!-- ******** body ********** -->
<h2>Client Care Mission</h2>
<br><h3><font color="#AA0000"><b> Services That Listen ...<i>continued</i></h3>

<div align="justify"><h6>
Our customer care mission commits to energizing your bottom-line success by delivering powerful, proven combinations of project management, development life cycles, and core technology solutions.  For complex projects, we use Project Management Office (PMO) structures.  In product development life cycles, we deploy Unified Modeling Language (UML), which provides tremendous flexibility and degrees of scale.  Our overall project management team utilizes Productivity Management™ Principles (developed by Keane, Inc.) to ensure prolific project, people and change management. 
</h6><h6>
AscendantOne’s service priorities underscore personalized attention to fully understand how our customers learn, adopt and maintain technology solutions in pursuit of strategic business goals.
<img align="right" src="/images/womanwsc.jpg">  With this approach, we offer our customers much more than just a cookie-cutter prescription for “business or service as usual.”  Instead, we offer a true, dynamic partnership for success.  We stress a measurable customer care approach that complements our solutions -- one that leverages both our organizations' knowledge and skill.  We make every effort to draw on your existing assets and expertise.  We’ll link up with you to create new value and achieve better economic results, always in accordance with your evolving business vision.
</h6><h6>
Everyone in our company understands that when we treat you with respect and listen carefully, then provide the exemplary service you expect, our reward is your allegiance to a long-term business relationship. 
</h6>
</div>
