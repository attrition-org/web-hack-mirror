<html>
<head>
<title> A s c e n d a n t O n e - UML Introduction </title>
<meta name="description" content="Strategic Partnering...AscendantOne, Inc. is a pioneering company established to help modernize insurance and financial services technology. ">
...
<br><center> <img src="/images/umlheading.gif"></center>
</center>
<!-- ******** body ********** -->
<BR>
<h3>A Brief Introduction To The UML Development Methodology</h3>
<h5>A number of design methodologies appeared in the nineties that allow business analysts to define system requirements in ways that led to effective "Object Oriented" system implementations.  These methodologies not only provide the processes that control the design from concept through test but supply technology tools to automate the process.
</h5><h5>
<P>Four methodologies were considered as <EM>de facto</EM>
 standards until the mid-nineties when three
of them merged to become what is today called the <b>Unified Modeling Language</b> (UML)</h5>


<h5>One of UML's basic principles is its ability to iteratively design computer applications.  This characteristic is very important to AscendantOne, allowing us to develop our early products --such as quote and new business -- with the confidence that we can reliably and efficiently later enhance these applications to:
:</h5>
<ul><h5>
<li>Solve subsequent business requirements such as policy endorsements
<li>Support the product in additional market environments such as affinity groups
<li>Make maintenance an ongoing part of the iterative process.
</ul></h5>

<h5>A good analogy for the UML process is the way architectural firms design buildings.  They first meet with future occupants and identify their perceived needs.  Using their accumulated domain experience they then expand these needs into functional requirement for the building, meeting not only the occupants needs but also generally accepted criteria for similar structures such as zoning regulations and building codes.  They also design characteristics into the building to make it unique.  </h5>

<h5>The result is expressed as a set of conceptual drawings, models and overall blueprints.  These are presented to all the interested parties to secure approval to continue.  Adjustments are made as needed.</h5>


<div align="right"><h3><a href="uml1.asp"><img src="images/tonext.gif" border="0"></a></h3></div>
