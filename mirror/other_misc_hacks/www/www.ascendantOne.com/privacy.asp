<html>
<head>
<title> A s c e n d a n t O n e  - Privacy </title>
...
<br><Br>
<center> <h1><b>Privacy </b></h1></center>
<!-- ******** body ********** -->
<div align="justify"><h5>
                                 

Thank you for visiting the AscendantOne Web site. This Site was created to offer you insight into our company, management and services,
 as well as other exciting company developments. We believe in the importance of your privacy, and protecting your privacy is one
 of our priorities.
</h5><h5>
The following discloses our information-gathering and dissemination practices for this Web site. The visitor's IP address is used to
 help identify users and to track user sessions. This gives AscendantOne an idea of which pages of our site users are visiting. We do not link
 IP addresses to anything personally identifiable. We also track browser, search engine and keyword preferences. Again, this is
 collected to gain insight on how we can improve our Web site.  This site does not collect personally identifying information about
 individuals except when specifically and knowingly provided by such individuals.
</h5><h5>
This site contains links to other sites. AscendantOne is not responsible for the privacy practices or the content of such Web sites. 
</h5><h5>
If you have any questions about this privacy statement, the practices of our site, or your dealings with this Web site, please send
 an e-mail to <a href="mailto:info@AscendantOne.com">info@AscendantOne.com</a>. </h5></div>
