...
<title> A s c e n d a n t O n e - Tour </title>
...
<br><center> <img src="/images/tourheading.gif" height="48" width="124" alt="Tour"></center>
</center>
<!-- ******** body ********** -->

<table width="580" cellpadding="10"><tr><td>
<img src="images/demoscreen3.gif" height="173" width="200" border="0" alt="demo login screen"></td><td>

<h2><font color="#AA0000">eValueQuote</h2><font color="black">
<h5><div align="justify">
For P&amp;C insurance companies that endure high policy processing costs,
AscendantOne's web/network-enabled policy management and information integration
services provide immediate competitive advantage and real benefits to bottom-line expense ratios.</div><br>
...
<table width="580" cellpadding="10"><tr><td>
<a href="marcom/AscendantOne-Corp-Overview1.ppt"><img src="marcom/overviewppt.gif" width="218" height="169" border="0" alt="300kb PowerPoint Presentation"></a></td><td>

<h2><font color="#AA0000">PowerPoint Presentation</h2><font color="black">
<h5><div align="justify">
<a href="marcom/AscendantOne-Corp-Overview1.ppt">AscendantOne-Corp-Overview1.ppt  <br><small>   Download - 300kb </small> </a>
</div></h5>
</td></tr></TABLE>
