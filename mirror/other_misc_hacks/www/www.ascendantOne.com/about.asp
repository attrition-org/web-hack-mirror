<html>
<head>
<title> A s c e n d a n t O n e - About </title>
...
<br><center> <img src="images/aboutheading.gif"></center>
<!-- ******** body ********** -->
<font face="arial" size="2">
<table width="550"><tr><td>
<div align="justify"><img src="images/majed1.jpg" align="left" width="159" height="110"><h5>
Unlike many emerging ventures, AscendantOne is a <i>mature</i> start-up, already possessing hard-won appreciation of the complexities and opportunities facing the industry.  The founding partners are industry veterans.  They recognize the inherent challenges of financial services automation.  
They have been at the forefront of exploiting technology to improve business results.  
 </h5></div></td></tr></table>
<img src="images/Rule-mgmt.gif" width="535" height="40"><br>
<a href="people-paul.asp"><STRONG>Paul Philp, </strong><i>President and CEO</i></a> <br>
<a href="people-chuck.asp"><STRONG>Charles Boodro, </strong><i> Chief Technology Officer</i> </a><br>
<a href="people-don.asp"><STRONG>Don Chase,  </strong><i>Executive Vice President, Sales &amp; Marketing</i></a><br>
<form><center><font face="arial" size="2">
<select name="Staff Bio List" onchange="if((w=this.options[this.selectedIndex].value) !='')window.location = w">
<option value=""> AscendantOne Team Bios
<option value="http://AscendantOne.com/people-greg.asp">Greg Vrakatitsis, Vice President, Customer Care 
<option value="http://AscendantOne.com/people-jonathan.asp">Jonathan Kaplan, Vice President, Product Development 
<option value="http://AscendantOne.com/people-massood.asp">Massood Abolfazli, Vice President, Marketing 
<option value="http://AscendantOne.com/people-david.asp">David Ethier, Director, Technology Partners 
<option value="http://AscendantOne.com/people-chris.asp">Chris Grey, Director, Business Solution Services 
<option value="http://AscendantOne.com/people-susan.asp">Susan Daly, Manager, Customer Services 
<option value="http://AscendantOne.com/people-bart.asp">Bart Webb, Account Executive 
<option value="http://AscendantOne.com/people-joecarrabis.asp">Joseph Carrabis, Chief Research Scientist 
<option value="http://AscendantOne.com/people-wendy.asp">Wendy Blackwell, Manager, Web Services
<option value="http://AscendantOne.com/people-peter.asp">Peter Kelley, Manager, Rating Services 
<option value="http://AscendantOne.com/people-caren.asp">Caren Firth, Business Analyst 
<option value="http://AscendantOne.com/people-karen.asp">Karen Plant, Manager, Quality Assurance 
<option value="http://AscendantOne.com/people-joetringali.asp">Joe Tringali, Systems Architect 
<option value="http://AscendantOne.com/people-joann.asp">Jo-Ann Thibault, Office/Human Resource Manager 
<option value="http://AscendantOne.com/people-terry.asp">Terri Dugrenier, Business Analyst 
<option value="http://AscendantOne.com/people-geoff.asp">Geoffrey Gengras, Engagement Manager 
<option value="http://AscendantOne.com/people-nanci.asp">Nanci Santos, Administrator, Sales & Marketing

</select><br></form>
<img src="images/rule.gif" width="535" height="29">
<table width="570" cellpadding="10"><tr><td><div align="justify"><h6>
Combined, the company's management team also represents vast experience -- 
highlighted by success at practical and strategic implementations in a variety of
 insurance and financial services disciplines.  Key staff members have been carefully 
selected for their unique
skills in both provider and technology spheres.</h6></div>
<font size="2"><b><a href="charter.asp">More on  Our Charter and Value Proposition </a>
</td><td valign="top"><img src="images/icolumn.jpg" width="180" height="117"></td></tr></table>
</td></tr></table>
</font>
