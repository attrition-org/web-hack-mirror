...
if (ToolBar_Supported)
{
	...
	HTMLStr = 
		...
		"<DIV ID='idMSMenuCurve' STYLE='position:absolute;top:0;left:250;height:20;width:18;overflow:hidden;vertical-align:top;'><IMG SRC='/topware/library/toolbar/images/curve.gif' BORDER=0></DIV>" +
...
{	tempGif = "/topware/library/toolbar/images/" + Gif;
...
function formatURL(URLStr, InstrumentStr)
{
	...
	if (DoInstrumentation && URLStr != "" )
	{
		...
		//tempStr = URL + tempStr + InstrumentStr.replace(" ","%20") + Bookmark;  // 2001-02-02
		tempStr = URL + Bookmark;
	}
	return tempStr;
}
...
function prepTrackingString(ts, type)
{
	...
	if (7 == type)
	{
		...
		if(rString.indexOf("topware") != -1)
		{
			rString = rString.substring(0,rString.indexOf("topware"));
			if('' == rString)
			{
				rString = "www";
			}	
...
{
	var TG = '<LAYER visibility="hide"><div style="display:none;"><IMG src="' + location.protocol + '//web001/topware/trans_gif.asp?';
