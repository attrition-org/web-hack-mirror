...
<SCRIPT>
	...
	function changeCategory(strForm)
	{
		...
		document.frmMonthReportFormRefresh.elements(0).value  = strForm.elements(0).value;		
		if (strForm.elements(1).disabled==true)
		{
			document.frmMonthReportFormRefresh.elements(1).value = 0;		
		}
		else
		{
			document.frmMonthReportFormRefresh.elements(1).value = parseInt(strForm.elements(1).value);
		}
			
		if (strForm.elements(2).checked==true)
		{
			document.frmMonthReportFormRefresh.elements(2).value  = strForm.elements(2).value;
		}
		else
		{
			document.frmMonthReportFormRefresh.elements(2).value  = 0; 
		}
		
		if (strForm.elements(3).checked==true)
		{
			document.frmMonthReportFormRefresh.elements(3).value  = strForm.elements(3).value;
		}
		else
		{
			document.frmMonthReportFormRefresh.elements(3).value  = 0; 
		}	
		
		if (strForm.elements(4).checked==true)
		{
			document.frmMonthReportFormRefresh.elements(4).value  = strForm.elements(4).value;
		}
		else
		{
			document.frmMonthReportFormRefresh.elements(4).value  = 0; 
		}
		
		if (strForm.elements(5).checked==true)
		{
			document.frmMonthReportFormRefresh.elements(5).value  = strForm.elements(5).value;
		}
		else
		{
			document.frmMonthReportFormRefresh.elements(5).value  = 0; 
		}
		
		document.frmMonthReportFormRefresh.elements(6).value  = strForm.elements(6).value;		
		document.frmMonthReportFormRefresh.elements(7).value  = strForm.elements(7).value;		
		document.frmMonthReportFormRefresh.elements(8).value  = strForm.elements(8).value;		
		document.frmMonthReportFormRefresh.elements(9).value  = strForm.elements(9).value;		
		document.frmMonthReportFormRefresh.elements(10).value  = strForm.elements(10).value;		
		
		document.frmMonthReportFormRefresh.submit();
	} 
...
//		nToDay       = parseInt(strForm.ToDay.value)
		...
		if (strForm.LastMonth.checked==false)
		{
...
<!---------------  The Top Navigation of IDSC Memory  ----------------------->
	...
	<TABLE width="100%" border=0 cellspacing=0 cellpadding=0 align="CENTER" height="100%" bgcolor="#336699">
		...
		<TD width="52%" valign="TOP" align="CENTER">
				...
				<TR>
					<TD width="100%" align="CENTER" valign="TOP" bgcolor="#ffffff">
							...
							<TABLE width="90%" align="CENTER" border=0 cellspacing=0 cellpadding=0 bgcolor="WHITE">
								...
								<TR>
									<TD align="LEFT" colspan=3>
										<FORM name="month_report_search" action="month_report_search_result.asp" method="POST">
						...
						-->																
										...
										-->				</TR>
											...
											<TR>
												<TD width="70%" align="RIGHT" valign="TOP" bgcolor="#e6e6ea">
													...
													<B>تقرير الإنجاز الشهرى الحالى</B>
													</FONT>
													<INPUT type="CHECKBOX" name="LastMonth" value="1" onClick="enableComboBox(this);">
												</TD>
												<TD width="30%" align="RIGHT" valign="MIDDLE" bgcolor="#b0c4de">
							...
							<FORM name="frmMonthReportFormRefresh" action="month_report_search.asp" method="POST">
			...
			-->					<INPUT type="HIDDEN" name="LastMonth"   value=0>
