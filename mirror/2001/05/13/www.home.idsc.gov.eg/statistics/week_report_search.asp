...
<SCRIPT>
	...
	function changeCategory(strForm)
	{
		...
		document.frmWeekReportFormRefresh.elements(0).value  = strForm.elements(0).value;		
		if (strForm.elements(1).disabled==true)
		{
			document.frmWeekReportFormRefresh.elements(1).value = 0;		
		}
		else
		{
			document.frmWeekReportFormRefresh.elements(1).value = parseInt(strForm.elements(1).value);
		}
		
		if (strForm.elements(2).checked==true)
		{
			document.frmWeekReportFormRefresh.elements(2).value  = strForm.elements(2).value;
		}
		else
		{
			document.frmWeekReportFormRefresh.elements(2).value  = 0; 
		}
		
		if (strForm.elements(3).checked==true)
		{
			document.frmWeekReportFormRefresh.elements(3).value  = strForm.elements(3).value;
		}
		else
		{
			document.frmWeekReportFormRefresh.elements(3).value  = 0; 
		}	
		
		if (strForm.elements(4).checked==true)
		{
			document.frmWeekReportFormRefresh.elements(4).value  = strForm.elements(4).value;
		}
		else
		{
			document.frmWeekReportFormRefresh.elements(4).value  = 0; 
		}
		
		if (strForm.elements(5).checked==true)
		{
			document.frmWeekReportFormRefresh.elements(5).value  = strForm.elements(5).value;
		}
		else
		{
			document.frmWeekReportFormRefresh.elements(5).value  = 0; 
		}
			
		document.frmWeekReportFormRefresh.elements(6).value  = strForm.elements(6).value;		
		document.frmWeekReportFormRefresh.elements(7).value  = strForm.elements(7).value;		
		document.frmWeekReportFormRefresh.elements(8).value  = strForm.elements(8).value;		
		document.frmWeekReportFormRefresh.elements(9).value  = strForm.elements(9).value;		
		document.frmWeekReportFormRefresh.elements(10).value = strForm.elements(10).value;		
		document.frmWeekReportFormRefresh.elements(11).value = strForm.elements(11).value;		
		document.frmWeekReportFormRefresh.elements(12).value = strForm.elements(12).value;		
		
		document.frmWeekReportFormRefresh.submit();
	} 
	...
	function validateForm(strForm)
	{
		...
		if (strForm.LastWeek.checked==false)
		{
				...
				<TR>
					<TD width="100%" align="CENTER" valign="TOP" bgcolor="#ffffff">
							...
							<TABLE width="90%" align="CENTER" border=0 cellspacing=0 cellpadding=0 bgcolor="WHITE">
								...
								<TR>
									<TD align="LEFT" colspan=3>
										<FORM name="week_report_search" action="week_report_search_result.asp" method="POST">
						...
						<!--									
											<TR>
												<TD width="70%" align="RIGHT" valign="TOP" bgcolor="#e6e6ea">
													...
													<OPTION value=0 SELECTED>جميع عناصر التقرير</OPTION><option  value=1 SELECTED>المخرجات</OPTION><option  value=2>الانجازات الرئيسيه</OPTION><option  value=3>الانشطه الرئيسيه</OPTION><option  value=4>رجل الاسبوع</OPTION>
													</SELECT></TD>
												<TD width="30%" align="RIGHT" valign="MIDDLE" bgcolor="#b0c4de">
						...
						-->																
													...
													<TABLE width="100%" border=0 align="RIGHT" cellspacing=2 cellpadding=2>	
														<TR>
															<TD width="45%" align="RIGHT" valign="MIDDLE">
																<B><FONT color="#336699" face="TAHOMA" style="FONT-SIZE:8pt">
																إنجازات
																</FONT></B>
															</TD>
											...
											<TR>
												<TD width="70%" align="RIGHT" valign="TOP" bgcolor="#e6e6ea">
													<TABLE width="80%" border=1 cellspacing=1 cellpadding=1 align="RIGHT">
														<TR>
											...
											<TR>
												<TD width="70%" align="RIGHT" valign="TOP" bgcolor="#e6e6ea">
													<FONT color="#336699" face="TAHOMA" style="FONT-SIZE:8pt">
													<B>تقرير المتابعة للإسبوع الحالى</B>
													</FONT>
													<INPUT type="CHECKBOX" name="LastWeek" value="1" onClick="enableComboBox(this);">
												</TD>
												<TD width="30%" align="RIGHT" valign="MIDDLE" bgcolor="#b0c4de">
							...
							<FORM name="frmWeekReportFormRefresh" action="week_report_search.asp" method="POST">
								...
								<INPUT type="HIDDEN" name="LastWeek"    value=0>
