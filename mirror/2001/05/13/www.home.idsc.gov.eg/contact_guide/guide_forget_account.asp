...
<HTML>
<HEAD>
<META NAME="GENERATOR" Content="Microsoft Visual Studio 6.0" charset="windows-1256">
...
<SCRIPT>
	...
	function validateForm(strForm)
	{
		...
		{	
			alert("من فضلك : تأكد من بريدك الإلكترونى");
			bRetVal = false;
		}
			...
			<TABLE width="100%" align="CENTER" border=0 bgcolor="WHITE" cellpadding=5>
				<TR>
					<TD>
								...
								<CENTER>
								<B><FONT color="ROYALBLUE" face="TAHOMA" style="FONT-SIZE:8pt">
								أدخل بريدك الإلكترونى و إضغط إرسل لكى يتم إرسال<BR><BR> إسم المستخدم و كلمة السر إلى بريدك الإلكترونى 
								</FONT></B>
								</CENTER>
								<BR>
								...
								<TABLE width="90%" align="CENTER" border=0 cellspacing=0 cellpadding=0 bgcolor="WHITE">
									...
									<TR>
										<TD align="LEFT" colspan=3>
											<FORM name="emp_forget_account" action="guide_forget_account.asp" method="POST">
											<TABLE width="100%" align="CENTER" border=0 cellspacing=1 cellpadding=5>

												<TR>
													<TD width="70%" align="RIGHT" bgcolor="#e6e6ea">
													...
													<TD width="30%" valign="MIDDLE" align="RIGHT" bgcolor="#b0c4de">
														<FONT face="TAHOMA"  color="#000000" style="FONT-SIZE:8pt"><B>
														البريد الإلكترونى	
														</B></FONT>
													</TD>
									...
									<TR>
										...
										<TD align="CENTER" width="80%" valign="MIDDLE" bgcolor="#b0c4de">
											<INPUT type="HIDDEN" name="ForgottenAccount" value="1">
											<TABLE width="100%" cellspacing=5 cellpadding=3 bgcolor="#b0c4de">
												<TR>
													...
													<TD width="50%" align="LEFT" valign="TOP">
														<INPUT type="SUBMIT" name="Submit1"   value="     إرسل    "    style="WIDTH:100;BACKGROUND-COLOR: #6699cc; COLOR: white" onClick="return validateForm(this.form);">
													</TD>
												</TR>
											</TABLE>
										</TD>
