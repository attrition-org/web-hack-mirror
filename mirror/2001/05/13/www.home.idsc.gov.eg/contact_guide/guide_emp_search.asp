...
<SCRIPT>
	...
	{
		document.ContactSearchResult.PageNO.value = nIndex;
				
		document.ContactSearchResult.submit();
	}
...
<!---------------  The Top Navigation of IDSC Memory  ----------------------->
	...
	<TABLE width="100%" border=0 cellspacing=0 cellpadding=0 align="CENTER" height="100%" bgcolor="#336699">
		...
		<TD width="52%" valign="TOP" align="CENTER">
							...
							<TABLE width="90%" align="CENTER" border=0 cellspacing=0 cellpadding=0 bgcolor="WHITE">
								...
								<TR>
									<TD align="LEFT" colspan=3>
										<FORM name="employee_search" action="guide_emp_search.asp" method="POST">
										<TABLE width="100%" align="CENTER" border=0 cellspacing=1 cellpadding=5>

											<TR>
												<TD width="70%" align="RIGHT" valign="TOP" bgcolor="#e6e6ea">
													<INPUT type="TEXT" name="EmpName" maxlength=200 size=35 style="BORDER-BOTTOM: black 1px groove; BORDER-LEFT: black 1px groove; BORDER-RIGHT: black 1px groove; BORDER-TOP: black 1px groove" dir="RTL"><BR>
												</TD>
											...
											<TR>
												<TD width="70%" align="RIGHT" valign="TOP" bgcolor="#e6e6ea">
													<INPUT type="TEXT" name="EmpWorkPhone" maxlength=15 size=15 style="BORDER-BOTTOM: black 1px groove; BORDER-LEFT: black 1px groove; BORDER-RIGHT: black 1px groove; BORDER-TOP: black 1px groove" dir="RTL"><BR>
												</TD>
												<TD width="30%" align="RIGHT" valign="MIDDLE" bgcolor="#b0c4de">
													<FONT face="TAHOMA"  color="#000000" style="FONT-SIZE:8pt">
													<B>تليفون العمل</B>
											...
											<TR>
												<TD width="70%" align="RIGHT" valign="TOP" bgcolor="#e6e6ea">
													<INPUT type="TEXT" name="EmpInternalPhone" maxlength=15 size=15 style="BORDER-BOTTOM: black 1px groove; BORDER-LEFT: black 1px groove; BORDER-RIGHT: black 1px groove; BORDER-TOP: black 1px groove" dir="RTL"><BR>
												</TD>
												<TD width="30%" align="RIGHT" valign="MIDDLE" bgcolor="#b0c4de">
													<FONT face="TAHOMA"  color="#000000" style="FONT-SIZE:8pt">
													<B>الرقم الداخلى</B>
											...
											<TR>
												<TD width="70%" align="RIGHT" valign="TOP" bgcolor="#e6e6ea">
													<INPUT type="TEXT" name="EmpEmail"  maxlength=100 size=35 style="BORDER-BOTTOM: black 1px groove; BORDER-LEFT: black 1px groove; BORDER-RIGHT: black 1px groove; BORDER-TOP: black 1px groove"><BR>
												</TD>
												<TD width="30%" align="RIGHT" valign="MIDDLE" bgcolor="#b0c4de">
													<FONT face="TAHOMA"  color="#000000" style="FONT-SIZE:8pt">
										...
										<TABLE width="100%" cellspacing=5 cellpadding=3 bgcolor="#b0c4de">
											<TR>
												...
												<TD width="50%" align="LEFT" valign="TOP">
													<INPUT type="SUBMIT" name="Submit1"   value="  إستعلام  "    style="WIDTH:100;BACKGROUND-COLOR: #6699cc; COLOR: white" >
												</TD>
											</TR>
										</TABLE>
									</TD>
			...
			<FORM name="ContactSearchResult" action="guide_emp_search.asp" method="POST">
					
				<INPUT type="HIDDEN" name="EmpName"          value="">
				<INPUT type="HIDDEN" name="EmpWorkPhone"     value="">
				<INPUT type="HIDDEN" name="EmpInternalPhone" value="">
				<INPUT type="HIDDEN" name="EmpEmail"         value="">
				<INPUT type="HIDDEN" name="EmpDepartment"    value= >
				<INPUT type="HIDDEN" name="SearchEmployee"   value="1">
