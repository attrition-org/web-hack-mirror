...
<SCRIPT>
	...
	function validateForm(strForm)
	{
		...
		bTempVal = checkIsEmpty(strForm.EmpName.value);
		if (bTempVal==false && bRetVal==true)   
		{	
			alert("من فضلك : تأكد من الإسم");
			bRetVal = false;
		}
			
		bTempVal = checkSelection(parseInt(strForm.EmpDepartment.value),0);
		if (bTempVal==false && bRetVal==true)   
		{	
			alert("من فضلك : إختر البرنامج أو القطاع التابع له");
			bRetVal = false;
		}
		
		bTempVal  = checkFieldLength(strForm.EmpWorkPhone.value,6);	
		bTempVal1 = checkIsEmpty(strForm.EmpWorkPhone.value);	
//		bTempVal2 = checkIsNumber(strForm.OrgTel1.value);	
//		if (bRetVal==true && (bTempVal1==false || bTempVal2==false || bTempVal==false))   
		if (bRetVal==true && (bTempVal1==false || bTempVal==false))   
		{	
			alert("من فضلك : تأكد من رقم التليفون");
			bRetVal = false;
		}
	
		bTempVal  = checkFieldLength(strForm.EmpInternalPhone.value,3);	
		bTempVal1 = checkIsEmpty(strForm.EmpInternalPhone.value);	
//		bTempVal2 = checkIsNumber(strForm.OrgTel1.value);	
//		if (bRetVal==true && (bTempVal1==false || bTempVal2==false || bTempVal==false))   
		if (bRetVal==true && (bTempVal1==false || bTempVal==false))   
		{	
			alert("من فضلك : تأكد من رقم التليفون الداخلى");
			bRetVal = false;
		}
		
		bTempVal = checkEmail(strForm.EmpEmail.value);	
		if (bRetVal==true && bTempVal==false)   
		{	
			alert("من فضلك : تأكد من البريد الإلكترونى");
			bRetVal = false;
		}
		
		bTempVal  = checkFieldLength(strForm.EmpUserName.value,8);	
		bTempVal1 = checkIsEmpty(strForm.EmpUserName.value);	
		if (bRetVal==true && (bTempVal1==false || bTempVal==false))   
		{	
			alert("من فضلك : لابد الا يقل إسم المستخدم عن 8 حروف");
			bRetVal = false;
		}
				
		bTempVal  = checkFieldLength(strForm.EmpUserPwd.value,8);	
		bTempVal1 = checkIsEmpty(strForm.EmpUserPwd.value);	
		if (bRetVal==true && (bTempVal1==false || bTempVal==false))   
		{	
			alert("من فضلك : لابد الا تقل كلمة السر عن 8 حروف");
			bRetVal = false;
		}
							...
							<TABLE width="90%" align="CENTER" border=0 cellspacing=0 cellpadding=0 bgcolor="WHITE">
								...
								<TR>
									<TD align="LEFT" colspan=3>
										<FORM name="employee_addnew" action="guide_emp_addnew.asp" method="POST">
										<TABLE width="100%" align="CENTER" border=0 cellspacing=1 cellpadding=5>

											<TR>
												<TD width="70%" align="RIGHT" valign="TOP" bgcolor="#e6e6ea">
													<INPUT type="TEXT" name="EmpName" value="" maxlength=200 size=35 style="BORDER-BOTTOM: black 1px groove; BORDER-LEFT: black 1px groove; BORDER-RIGHT: black 1px groove; BORDER-TOP: black 1px groove" dir="RTL"><BR>
												</TD>
											...
											<TR>
												<TD width="70%" align="RIGHT" valign="TOP" bgcolor="#e6e6ea">
													<SELECT name="EmpDepartment" style="WIDTH: 233px" dir="RTL">
											...
											<TR>
												<TD width="70%" align="RIGHT" valign="TOP" bgcolor="#e6e6ea">
													<INPUT type="TEXT" name="EmpWorkPhone" value="" maxlength=15 size=15 style="BORDER-BOTTOM: black 1px groove; BORDER-LEFT: black 1px groove; BORDER-RIGHT: black 1px groove; BORDER-TOP: black 1px groove" dir="RTL"><BR>
												</TD>
												<TD width="30%" align="RIGHT" valign="MIDDLE" bgcolor="#b0c4de">
													<FONT face="TAHOMA"  color="#000000" style="FONT-SIZE:8pt">
													<B>تليفون العمل</B>
											...
											<TR>
												<TD width="70%" align="RIGHT" valign="TOP" bgcolor="#e6e6ea">
													<INPUT type="TEXT" name="EmpInternalPhone" value="" maxlength=15 size=15 style="BORDER-BOTTOM: black 1px groove; BORDER-LEFT: black 1px groove; BORDER-RIGHT: black 1px groove; BORDER-TOP: black 1px groove" dir="RTL"><BR>
												</TD>
												<TD width="30%" align="RIGHT" valign="MIDDLE" bgcolor="#b0c4de">
													<FONT face="TAHOMA"  color="#000000" style="FONT-SIZE:8pt">
													<B>الرقم الداخلى</B>
											...
											<TR>
												<TD width="70%" align="RIGHT" valign="TOP" bgcolor="#e6e6ea">
													<INPUT type="TEXT" name="EmpEmail"  value="" maxlength=100 size=35 style="BORDER-BOTTOM: black 1px groove; BORDER-LEFT: black 1px groove; BORDER-RIGHT: black 1px groove; BORDER-TOP: black 1px groove"><BR>
												</TD>
												<TD width="30%" align="RIGHT" valign="MIDDLE" bgcolor="#b0c4de">
													<FONT face="TAHOMA"  color="#000000" style="FONT-SIZE:8pt">
											...
											<TR>
												<TD width="70%" align="RIGHT" valign="TOP" bgcolor="#e6e6ea">
													<INPUT type="TEXT" name="EmpUserName" value="" maxlength=50 size=15 style="BORDER-BOTTOM: black 1px groove; BORDER-LEFT: black 1px groove; BORDER-RIGHT: black 1px groove; BORDER-TOP: black 1px groove"><BR>
												</TD>
												<TD width="30%" align="RIGHT" valign="MIDDLE" bgcolor="#b0c4de">
													<FONT face="TAHOMA"  color="#000000" style="FONT-SIZE:8pt">
													<B>إسم المستخدم</B>
											...
											<TR>
												<TD width="70%" align="RIGHT" valign="MIDDLE" bgcolor="#e6e6ea">
													<INPUT type="PASSWORD" name="EmpUserPwd" value="" maxlength=50 size=15 style="BORDER-BOTTOM: black 1px groove; BORDER-LEFT: black 1px groove; BORDER-RIGHT: black 1px groove; BORDER-TOP: black 1px groove"><BR>
												</TD>
												<TD width="30%" align="RIGHT" valign="MIDDLE" bgcolor="#b0c4de">
													<FONT face="TAHOMA"  color="#000000" style="FONT-SIZE:8pt">
													<B>كلمة السر</B>
								...
								<TR>
									...
									<TD align="CENTER" width="80%" valign="MIDDLE" bgcolor="#b0c4de">
										<INPUT type="HIDDEN" name="AddNewEmployee"  value="1">
										<TABLE width="100%" cellspacing=5 cellpadding=3 bgcolor="#b0c4de">
											<TR>
												...
												<TD width="50%" align="LEFT" valign="TOP">
													<INPUT type="SUBMIT" name="Submit1"   value="  تسجيل  "    style="WIDTH:100;BACKGROUND-COLOR: #6699cc; COLOR: white" onClick="return validateForm(this.form);">
												</TD>
											</TR>
										</TABLE>
									</TD>
