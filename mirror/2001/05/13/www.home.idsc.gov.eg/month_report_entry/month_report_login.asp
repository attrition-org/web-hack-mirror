						...
						<TABLE width="60%" align="CENTER" border=0 cellspacing=0 cellpadding=0 bgcolor="WHITE">
							...
							<TR>
								<TD align="LEFT" colspan=3>
									<FORM name="month_report_login" action="month_report_browse.asp" method="POST">
									...
									<TABLE width="100%" cellspacing=5 cellpadding=3 bgcolor="#b0c4de">
										<TR>
											<TD width="50%" align="RIGHT" valign="TOP">
												<INPUT type="RESET"  name="Reset1"        value="   إلغاء   "    style="WIDTH:70;BACKGROUND-COLOR: #6699cc; COLOR: white">
											</TD>
											<TD width="50%" align="LEFT" valign="TOP">
												<INPUT type="SUBMIT" name="Submit1"       value="   دخول  "    style="WIDTH:70;BACKGROUND-COLOR: #6699cc; COLOR: white" onClick="return validateForm(this.form);">
											</TD>
										</TR>
									</TABLE>
								</TD>
