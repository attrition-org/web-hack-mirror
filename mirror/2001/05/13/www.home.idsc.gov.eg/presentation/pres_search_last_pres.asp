...
<SCRIPT>
	...
	{
		document.frmPresSearchResult.PageNO.value = nIndex;
				
		document.frmPresSearchResult.submit();
	}
...
<!---------------  The Top Navigation of IDSC Memory  ----------------------->
	...
	<TABLE width="100%" border=0 cellspacing=0 cellpadding=0 align="CENTER" height="100%" bgcolor="#336699">
		...
		<TD width="52%" valign="TOP" align="CENTER">
							...
							<TABLE width="90%" align="CENTER" border=0 cellspacing=0 cellpadding=0 bgcolor="WHITE">
								...
								<TR>
									<TD align="LEFT" colspan=3>
										<FORM name="frmPresSearch" action="pres_search_last_pres.asp" method="POST">
										<TABLE width="100%" align="CENTER" border=0 cellspacing=1 cellpadding=5>

											<TR>
												<TD width="70%" align="RIGHT" valign="TOP" bgcolor="#e6e6ea">
													<INPUT type="TEXT" name="PresTitle" maxlength=200 size=35 style="BORDER-BOTTOM: black 1px groove; BORDER-LEFT: black 1px groove; BORDER-RIGHT: black 1px groove; BORDER-TOP: black 1px groove" dir="RTL"><BR>
												</TD>
			...
			<FORM name="frmPresSearchResult" action="pres_search_last_pres.asp" method="POST">
