  ...
  <tr>
    ...
    <td align="left" valign="top" width="570">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr valign="middle"> 
                      ...
                      <td align="right"><b><font face="sans-serif,Arial, Helvetica" size="1"> 
                        Ultima Actualización: 1/6/2000<br>
                                ...
                                <form method="post" action="../ir.php3">
                                  <tr align="center" valign="middle"> 
                                    <td height="22" width="70%"><font face="Arial, Helvetica, sans-serif" size="2">&nbsp;[ 
                                      ...
                                      | <a href="default.php3"><b>Documentos</b></a> 
      ...
      <TABLE bgColor=#ffffff border=0 cellPadding=0 cellSpacing=0 width="100%">
        <TBODY> 
        <TR vAlign=top> 
          <TD background="../img/stripes.gif" 
    colSpan=3><IMG alt="" height=3 
      src="../img/pixel.gif" 
  width=1></TD>
        </TR>
        </TBODY> 
                ...
                <td> <!-- #BeginEditable "content" --> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top" align="left"> 
                      <td> <font face="Arial, Helvetica, sans-serif" size="2"><a href="../php/manual">Manul 
                        de PHP</a></font> <font face="Arial, Helvetica, sans-serif" size="2"> 
                        </font> </td>
                    </tr>
                  </table>
                  <!-- #EndEditable --></td>
