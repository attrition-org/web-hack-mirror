...
<HEAD> 
		<TITLE>Laser Vision Correction Contact Us - ClearSight Center</TITLE>
			...
			<TR VALIGN=top>
				...
				<TD WIDTH=490>
							...
							<TR VALIGN=TOP>
								...
								<IMG SRC="images/header_contactus.gif" WIDTH=330 HEIGHT=35  BORDER=0 ALT="Contact Us">

								<HTML>
<!--This file created 7/3/99 5:02 PM by Claris Home Page version 3.0-->
<HEAD>
...
<P><FONT FACE="Tahoma">If you would like more information or have
questions or comments, use our form and a representative will contact
you. We are here to answer YOUR questions 7 days a week between 9 AM
and 5 PM Central Standard Time. Give us a call at (405) 733-2020 or
1-888-733-2020. </FONT></P>
</BODY>
</HTML>
										...
										<TR><TD ALIGN=right><FONT SIZE=-1 FACE=arial>Name:</FONT></TD>
											<TD><INPUT TYPE="text" NAME="field1" SIZE=30></TD></TR>
										
										<TR><TD ALIGN=right><FONT SIZE=-1 FACE=arial>Telephone:</FONT></TD>
											<TD><INPUT TYPE="text" NAME="field2" SIZE=30></TD></TR>

										<TR><TD ALIGN=right><FONT SIZE=-1 FACE=arial>E-mail:</FONT></TD>
											<TD><INPUT TYPE="text" NAME="field3" SIZE=30></TD></TR>
											
										<TR><TD ALIGN=right><FONT SIZE=-1 FACE=arial>Insurance Company:</FONT></TD>
											<TD><INPUT TYPE="text" NAME="field4" SIZE=30></TD></TR>
											
										<TR><TD ALIGN=right><FONT SIZE=-1 FACE=arial>Member Number:</FONT></TD>
											<TD><INPUT TYPE="text" NAME="field5" SIZE=30></TD></TR>
										
										<TR><TD ALIGN=right><FONT SIZE=-1>Check the <BR>area(s)<BR> that<BR> interest<BR> you:</FONT></TD>
											<TD><FONT SIZE=-1>
												<INPUT TYPE="checkbox" NAME="field6" VALUE="Free Exam">No Obligation Initial Exam<BR>
												<INPUT TYPE="checkbox" NAME="field7" VALUE="Follow Up Exam">Follow Up Exam<BR>
												<INPUT TYPE="checkbox" NAME="field8" VALUE="Surgery Appointment">Surgery Appointment<BR>
												<INPUT type="checkbox" NAME="field9" VALUE="Personal Quote">Personal Quote<BR>
												<INPUT TYPE="checkbox" NAME="field10" VALUE="Insurance Coverage Check">Free Insurance Coverage Check<BR>
												<INPUT TYPE="checkbox" NAME="field11" VALUE="Payment Plan Information">Payment Plan Information<BR>
												</FONT></TD></TR>
								
										<TR><TD ALIGN=right><FONT SIZE=-1 FACE=arial>Questions or Comments:</FONT></TD>
											<TD ALIGN=left><TEXTAREA NAME="field12" ROWS=5 COLS=26 WRAP=SOFT></TEXTAREA></TD></TR>
								
										<TR><TD COLSPAN=2 ALIGN=center><BR><INPUT TYPE="submit" NAME="DataAction" VALUE="Send Request">&nbsp;&nbsp;&nbsp; <INPUT TYPE=reset VALUE="Clear Request"></FORM></TD></TR>
									</TABLE>
...
<BODY>
<P>
A few days after my Laser treatment I called my Mom crying.  I told her that I never believed I would see like this.  I had worn glasses since I was four years old and now, after just seconds of laser time, I was seeing clearly without him.
<P>
<UL>-Bonnie Lawler</UL> 
