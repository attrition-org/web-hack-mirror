<html><center><a href=banners.php3?op=click&bid=2><img src=http://mardigraszone.com/images/MardiGrasBanner4.gif border=1></a></center><br><html>
<head>
...
</td><td width=100% valign=top><table border=0 width=100% cellpadding=0 cellspacing=0 bgcolor=000000><tr><td><table border=0 width=100% cellpadding=8 cellspacing=1 bgcolor=FFFFFF><tr><td><font size=4>Submit News<font size=3><p><FORM action="submit.php3" method=post><font face=Arial,Helvetica><b>Your Name</b> MardiGrasRules! <font size=2>[ <a href="user.php3">New User</a> ]</font>	<P><B>Title</B>
...
<option  value="4">Bars / Nightlife</option>
<option  value="2">Beads</option>
<option  value="5">Jazz it up!</option>
<option  value="3">News</option>
<option  value="10">Not Just For Mardi Gras</option>
<option  value="1">Parades</option>
<option  value="6">Restaurants</option>
<option  value="9">Share your experience</option>
<option  value="7">Throwing A Party!!!</option>
	</select>
	<P><B>The Scoop</B>
