<html><center><a href=banners.php3?op=click&bid=3><img src=http://mardigraszone.com/images/MardiGrasBanner3.gif border=1></a></center><br><html>
<head>
...
<FONT FACE=Arial,Helvetica SIZE=2>
 ...
 <a href=links.php3?op=AddLink>Add URL</a></TD><TD><FONT FACE=Arial,Helvetica SIZE=2>
 <a href=links.php3?op=NewLinks>New Links</a></TD><TD><FONT FACE=Arial,Helvetica SIZE=2>
 <a href=links.php3?op=TheBest>The Best</a></TD><TD><FONT FACE=Arial,Helvetica SIZE=2>
...
<CENTER><BR>
    ...
    <tr><td><FONT FACE=Arial,Helvetica SIZE=2><input type=text size=30 name=query> <input type=submit value=Search></td></tr>
    </table>
    </div>
    </form>
...
<br><br><font size=2>There are <b>0</b> Links in our Database
