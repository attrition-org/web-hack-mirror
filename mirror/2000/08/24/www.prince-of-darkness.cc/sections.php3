<html><center><a href=banners.php3?op=click&bid=5><img src=images/banners/freshmeat.gif border=1></a></center><br><html>
<head>
...
<center><font face=Arial,Helvetica color=grey>
	Welcome to the Special Sections at Prince of Darkness.<br><br>
	Here you can find some cool articles not presents in the Home.
	<br><br>
	<table border=0>
	    <tr><td align=left><font face=Arial,Helvetica color=grey>
	    <li><a href=sections.php3?op=listarticles&secid=1>Games</a>
	    
	    </tr></td>
	    
	    <tr><td align=left><font face=Arial,Helvetica color=grey>
	    <li><a href=sections.php3?op=listarticles&secid=2>Security</a>
