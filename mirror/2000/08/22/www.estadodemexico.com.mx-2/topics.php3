...
<img src=images/pix.gif border=0 width=150 height=1>
	...
	<center><table border=0 width=100% align=center cellpadding=2><tr>			
		...
		<font face=Arial,Helvetica size=2><b>General		</td>
					
		<td align=center>
		<a href=search.php3?query=&topic=21><img src=images/topics/ border=0></a><br>
		<font face=Arial,Helvetica size=2><b>Deportes		</td>
					
		<td align=center>
		<a href=search.php3?query=&topic=22><img src=images/topics/ border=0></a><br>
		<font face=Arial,Helvetica size=2><b>Cultura y Espectaculos		</td>
