...
</td><td width=100% valign=top><table border=0 width=100% cellpadding=0 cellspacing=0 bgcolor=000000><tr><td><table border=0 width=100% cellpadding=8 cellspacing=1 bgcolor=FFFFFF><tr><td><font size=4>Enviar Noticia<font size=3><p><FORM action="submit.php3" method=post><font face=Arial,Helvetica><b>Tu Nombre</b> Anonimo <font size=2>[ <a href="user.php3">Nuevo Usuario</a> ]</font>	<P><B>Título</B>
...
<option  value="22">Cultura y Espectaculos</option>
