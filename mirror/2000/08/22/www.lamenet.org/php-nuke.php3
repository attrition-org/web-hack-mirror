...
</td><td width=100% valign=top><H1>404 Error - Not Found</H1><TABLE BORDER="0" CELLPADDING="8" BGCOLOR="#EEEEEE"><TR><TD><UL><LI>The page you requested does not exist on this server.</LI><LI>Either there is a mistake in the URL you entered or the page has been removed.</LI><LI>Please check the link and try again.</LI></UL></TD></TR></TABLE><td>&nbsp;</td><td valign="top" bgcolor="#778899"><table border=0 cellspacing=0 cellpadding=0 width=100% bgcolor=000000><tr><td>
<table width=100% border=0 cellspacing=1 cellpadding=3><tr><td colspan=1 bgcolor=CCCCCC>
<font face=Arial,Helvetica size=2>Survey</td></tr><tr><td bgcolor=FFFFFF><font face=Arial,Helvetica size=2>
<form action="pollBooth.php3" method="post"><input type="hidden" name="pollID" value="1"><input type="hidden" name="forwarder" value="pollBooth.php3?op=results&pollID=1"><font face=Arial,Helvetica size=2><b>What do you think of LameNet.org?</b><br><input type="radio" name="voteID" value="1"><font face=Arial,Helvetica size=2> Fantastic! <br><input type="radio" name="voteID" value="2"><font face=Arial,Helvetica size=2> Cool! <br><input type="radio" name="voteID" value="3"><font face=Arial,Helvetica size=2> Not bad. <br><input type="radio" name="voteID" value="4"><font face=Arial,Helvetica size=2> Needs SERIOUS work, dude! <br><input type="radio" name="voteID" value="5"><font face=Arial,Helvetica size=2> What the hell is this? <br><center><table cellspacing=0 cellpadding=5 border=0 width=111><tr><td align=center> <input type=image src=images/menu/english/vote.gif border=0></td><td align=center></form><a href="pollBooth.php3?op=results&pollID=1"><img src=images/menu/english/result.gif border=0></a></td></tr></table><a href="pollBooth.php3"><b>Past Surveys</a></b><br><br>Votes: <b>3</b></font></center></td></tr></table></td></tr></table><br>
    
<br>
<b>Warning</b>:  Supplied argument is not a valid MySQL result resource in <b>mainfile.php3</b> on line <b>171</b><br>
<table border=0 cellspacing=0 cellpadding=0 width=100% bgcolor=000000><tr><td>
<table width=100% border=0 cellspacing=1 cellpadding=3><tr><td colspan=1 bgcolor=CCCCCC>
