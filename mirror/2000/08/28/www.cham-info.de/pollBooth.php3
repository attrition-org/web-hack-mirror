...
<!-- columna de inicio -->
<table border=0 cellpadding=8><tr><td><font face=Arial,Helvetica size=3><li> <a href="pollBooth.php3?pollID=2">Wie oft gehen Sie ins Gaeubodenvolksfest?</a> (<a href="pollBooth.php3?op=results&pollID=2">Ergebnisse</a> - 20 Stimmen)
<li> <a href="pollBooth.php3?pollID=3">Mit welchem Betriebssystem surfen Sie?</a> (<a href="pollBooth.php3?op=results&pollID=3">Ergebnisse</a> - 2 Stimmen)
