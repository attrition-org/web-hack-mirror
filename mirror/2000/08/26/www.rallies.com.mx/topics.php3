...
<img src=images/pix.gif border=0 width=150 height=1>
	...
	<center><table border=0 width=100% align=center cellpadding=2><tr>			
		<td align=center>
		<a href=search.php3?query=&topic=1><img src=images/topics/logo-rac.jpg border=0></a><br>
		<font face=Arial,Helvetica size=2><b>Artículos y noticias del RAC		</td>
					
		<td align=center>
		<a href=search.php3?query=&topic=2><img src=images/topics/logo-caf.jpg border=0></a><br>
		<font face=Arial,Helvetica size=2><b>Artículos y noticias del CAF		</td>
					
		<td align=center>
		<a href=search.php3?query=&topic=3><img src=images/topics/deflogo.jpg border=0></a><br>
		<font face=Arial,Helvetica size=2><b>Comentarios, noticias y artículos		</td>
					
		<td align=center>
		<a href=search.php3?query=&topic=4><img src=images/topics/todo-rallies.jpg border=0></a><br>
		<font face=Arial,Helvetica size=2><b>Todo sobre los rallies en México		</td>
					
		<td align=center>
		<a href=search.php3?query=&topic=5><img src=images/topics/ border=0></a><br>
		<font face=Arial,Helvetica size=2><b>Campeonato Mundial de Rallies		</td>
