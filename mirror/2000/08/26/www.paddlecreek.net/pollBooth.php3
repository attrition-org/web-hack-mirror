...
</td><td width=100% valign=top><table border=0 cellpadding=8><tr><td><font face=Arial,Helvetica size=3><li> <a href="pollBooth.php3?pollID=2">How do you like paddlecreek.net?</a> (<a href="pollBooth.php3?op=results&pollID=2">Results</a> - 37 votes)
<li> <a href="pollBooth.php3?pollID=3">Now that Nathan is free, what should he be doing with all his extra time?</a> (<a href="pollBooth.php3?op=results&pollID=3">Results</a> - 41 votes)
<li> <a href="pollBooth.php3?pollID=4">Where is Josh?</a> (<a href="pollBooth.php3?op=results&pollID=4">Results</a> - 16 votes)
<li> <a href="pollBooth.php3?pollID=5">Pictures we would all like to see when Christopher and Nathan return from ORU.</a> (<a href="pollBooth.php3?op=results&pollID=5">Results</a> - 31 votes)
<li> <a href="pollBooth.php3?pollID=6">Why do you go to Thirsty Thursday?</a> (<a href="pollBooth.php3?op=results&pollID=6">Results</a> - 21 votes)
<li> <a href="pollBooth.php3?pollID=7">What makes Tofu so cute?</a> (<a href="pollBooth.php3?op=results&pollID=7">Results</a> - 16 votes)
<li> <a href="pollBooth.php3?pollID=8">What is your favorite Lord of The Rings character?</a> (<a href="pollBooth.php3?op=results&pollID=8">Results</a> - 27 votes)
<li> <a href="pollBooth.php3?pollID=9">How old is Mollie?</a> (<a href="pollBooth.php3?op=results&pollID=9">Results</a> - 15 votes)
</td></tr></table>
</td></tr></table>
</td></tr></table>
</body></html>
