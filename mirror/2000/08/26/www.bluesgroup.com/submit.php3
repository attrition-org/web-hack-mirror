...
<option  value="11">BLUES NEWS</option>
<option  value="13">DISCUSSION</option>
<option  value="12">FOR SALE</option>
<option  value="10">SITE NEWS</option>
<option  value="14">WANT ADS</option>
	</select>
	<P><B>The Scoop</B>
