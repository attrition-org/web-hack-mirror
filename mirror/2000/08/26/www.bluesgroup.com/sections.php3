...
<img src=images/pix.gif border=0 width=150 height=1>
	...
	Welcome to the Special Sections at Blues Group.<br><br>
	Here you can find some cool articles not presents in the Home.
	<br><br>
	<table border=0><td><a href=sections.php3?op=listarticles&secid=2><img src=images/sections/php-nuke.gif border=0 Alt="MP3 Sites"></a></td><td><a href=sections.php3?op=listarticles&secid=1><img src=images/sections/phpnuke.gif border=0 Alt="Photos"></a></tr></td></table></center></td></tr></table></td></tr></table>
</td></tr></table>
</td></tr></table>
</body></html>
