...
function _writeList() {
  ...
  for(var i = 0; i < this.types.length; i++) { 
    ...
    if(this.types[i] == "list") {
      str += "<TD WIDTH=15 NOWRAP VALIGN=MIDDLE><A TARGET='_self' HREF=\"javascript:expand("+this.lists[i].id+");\"><IMG BORDER=0 SRC=\"http://med01.nctsw.navy.mil/true.gif\" NAME=\"_img"+this.lists[i].id+"\"></A></TD>";
      _pid++;
    } else if(this.space)
  ...
  for(var i = 0; i < this.types.length; i++) { 
    ...
    if(this.types[i] == "list") {
      if(this.lists[i].visible) {
        ...
        if(isNav4) layer.document.images[0].src = "http://med01.nctsw.navy.mil/true.gif";
        else eval('document.images._img'+this.lists[i].id+'.src = "http://med01.nctsw.navy.mil/true.gif"');
      } else {
        if(isNav4) layer.document.images[0].src = "http://med01.nctsw.navy.mil/false.gif";
        else eval('document.images._img'+this.lists[i].id+'.src = "http://med01.nctsw.navy.mil/false.gif"');
      }
