...
<img src=images/pix.gif border=0 width=150 height=1>
		...
		<font size=2>Achtung: Usereinstellungen brauchen cookies. <a href="cookies.php3">mehr infos...</a></font><br>
		Als registrierter Benutzer k&ouml;nnen Sie:<br>
		<li> Kommentare mit Ihrem Namen versehen		<li> Artikel mit Ihrem Namen bereitstellen		<li> Eine personalisierte Seite haben.		<li> Needs translation		<li> Kommentare anpassen		<li> Themen ausw&auml;hlen		<li> some other cool stuff...<br>
		...
		<font size=2>
		Kein Problem. Nickname eingeben und send-Button dr&uuml;cken.<br>
