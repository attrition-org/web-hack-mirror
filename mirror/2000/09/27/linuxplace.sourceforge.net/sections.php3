<html><center><a href=banners.php3?op=click&bid=6><img src=http://sourceforge.net/images/valogo3.png border=1></a></center><br><html>
<head>
...
<img src=images/pix.gif border=0 width=150 height=1>
	...
	Welcome to the Special Sections at The Linux Place.<br><br>
	Here you can find some cool articles not presents in the Home.
	<br><br>
	<table border=0><td><a href=sections.php3?op=listarticles&secid=1><img src=images/sections/ border=0 Alt=""></a></td><td><a href=sections.php3?op=listarticles&secid=3><img src=images/sections/linux.gif border=0 Alt="Linux"></a></tr></td></table></center></td></tr></table></td></tr></table>
</td></tr></table>
</td></tr></table>
</body></html>
