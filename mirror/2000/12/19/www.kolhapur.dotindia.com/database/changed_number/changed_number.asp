...
<title>Kolhapur Telecom Changed Number Enquiry System</title>
</head>
...
<P><B><center><FONT FACE="Tahoma" SIZE=5 COLOR=#000080><P>Welcome To Changed Number Enquiry System</B></FONT></center></P>
...
{
  if (theForm.Old_No.value == "")  
         {
  	       alert("Please Enter Value In The Old Number Field");
    	    theForm.Old_No.focus();
    	    return (false);
         }
  else
     {  
  	   ...
  	   if (!(theForm.Old_No.value == ""))
  	   {
    	  var checkOK = "0123456789-.";
  	     var checkStr = theForm.Old_No.value;
  	     var allValid = true;
  	     var decPoints = 0;
  	     var allNum = "";
  	    ...
  	    if (!allValid)
  	    {
    	    alert("Please enter only digit characters in the Old Number field.");
    	    theForm.Old_No.focus();
    	    return (false);
  	    }
  	    ...
  	    if (decPoints > 0)
  	    {
    	    alert("Please enter a valid number in the Old Number field.");
    	    theForm.Old_No.focus();
    	    return (false);
  	    }
...
<form method="post" action="/database/changed_number/changed_number_resp.asp" onsubmit="return FormValidation(this)">
     <div align="center">
 ...
 <br>
  <table border="4" valign="top" cellspacing="4" cellpadding="2" width = 500>
    ...
    <tr align="left">
      ...
      <b><font face="Lucida Sans Typewriter" color="DARKBROWN">Please Enter Old Telephone Number</b></font></strong></p></div></td>
      
      <td width="40%" height="1"><div align="left"><p>
      <input name="Old_No" size="16"></p></div></td>
    </tr>
   ...
   <tr align="middle">
	...
	<input name="action" type="submit" value="Get New Number" style="HEIGHT: 30px; WIDTH: 120px"></td>
	 </tr>
...
<div></div>
	...
	<TD colspan = 3><center><a href="changed_number.asp">[Changed Number Enquiry]</a></center></TD>
