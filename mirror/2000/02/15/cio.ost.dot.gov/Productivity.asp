...
<TITLE>U.S. DOT Chief Information Officer - Productivity</TITLE>
...
<FONT SIZE=2><B><U>Productivity</U></B></FONT>
</P>
<TABLE BORDER=0 CELLPADDING=1 CELLSPACING=1 WIDTH="400">
<TR>
<TD><H4>Productivity</H4><TD>
</TR>
<TR>
	...
	<TD><TABLE BORDER=0 CELLPADDING=3 CELLSPACING=3>
		...
		<TH ALIGN=LEFT></TH>
		<TH ALIGN=LEFT><FONT SIZE=2><A HREF="Accessibility.asp" TARGET="MainFrame" OnMouseOver="message('Accessibility'); return true">Accessibility</A></FONT></TH>
		</TR>
		<TR ALIGN=LEFT VALIGN=TOP>
		<TH ALIGN=LEFT></TH>
		<TH ALIGN=LEFT><FONT SIZE=2><A HREF="Files/Dirmm/chapt14-3.pdf" TARGET="_parent" OnMouseOver="message('E-mail PDF'); return true">E-mail</A> - requires 
		<a HREF="http://www.adobe.com/prodindex/acrobat/readstep.html" TARGET="_blank" OnMouseOver="message('Get Adobe Acrobat'); return true">Adobe Acrobat</A></FONT></TH>
		</TR>
		<TR ALIGN=LEFT VALIGN=TOP>
		<TH ALIGN=LEFT></TH>
		<TH ALIGN=LEFT><FONT SIZE=2><A HREF="ECommerce.asp" TARGET="MainFrame" OnMouseOver="message('Electronic Commerce'); return true">Electronic Commerce</A></FONT></TH>
		</TR>
		<TR ALIGN=LEFT VALIGN=TOP>
		
			<TD><A NAME="ITLit"> </A><A HREF="Productivity.asp?ExpandLvl1=ITLit#ITLit" TARGET="MainFrame" OnMouseOver="message('Expand'); return true"><IMG SRC="images/Expand.GIF" WIDTH="20" HEIGHT="20" BORDER=0 ALT="Expand"></A></TD>
			<TH ALIGN=LEFT><FONT SIZE=2><A HREF="Productivity.asp?ExpandLvl1=ITLit#ITLit" TARGET="MainFrame" OnMouseOver="message('Expand'); return true">IT Literacy</A></FONT></TH>
		
		</TR>
		<TR ALIGN=LEFT VALIGN=TOP>
		<TH ALIGN=LEFT></TH>
		<TH ALIGN=LEFT><FONT SIZE=2>Performance Measurement</FONT></TH>
		</TR>
		<TR ALIGN=LEFT VALIGN=TOP>
		<TH ALIGN=LEFT></TH>
		<TH ALIGN=LEFT><FONT SIZE=2>Best Practices</FONT></TH>
		</TR>
	</TABLE></TD>
