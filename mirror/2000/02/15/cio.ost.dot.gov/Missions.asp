...
<TITLE>>U.S. DOT Chief Information Officer - DOT Missions and Programs</TITLE>
...
<FONT SIZE=2><B><U>Missions &amp; Programs</U></B></FONT>
</P>
<TABLE BORDER=0 CELLPADDING=1 CELLSPACING=1 WIDTH="395">
<TR>
<TD><H4>DOT Missions and Programs</H4>
<FONT SIZE=1><I>Information Technology(IT) is a critical enabler in performing DOT missions and programs. 
Specific IT initiatives are described in the following:</I></FONT>
<TD>
</TR>
<TR>
	...
	<TD><TABLE BORDER=0 CELLPADDING=3 CELLSPACING=3>
		...
		<TH WIDTH=20></TH>
		<TH ALIGN=LEFT><FONT SIZE=2><A HREF="http://152.119.34.12/CIO" TARGET="_blank" OnMouseOver="message('Capital Programming/Financial Profile'); return true">Capital Programming/Financial Profile</A></FONT></TH>
		</TR>
		<!--<TR ALIGN=LEFT VALIGN=TOP>
		<TH WIDTH=20></TH>
		<TH ALIGN=LEFT><FONT SIZE=2><A HREF="MajorSystems.asp" TARGET="MainFrame" OnMouseOver="message('Major Systems'); return true">Major Systems</A></FONT></TH>
		</TR>-->
		<TR ALIGN=LEFT VALIGN=TOP>
		
			<TD><A NAME="Invest"> </A><A HREF="Missions.asp?ExpandLvl1=InvestSelect#Invest" TARGET="MainFrame" OnMouseOver="message('Expand'); return true"><IMG SRC="images/Expand.GIF" WIDTH="20" HEIGHT="20" BORDER=0 ALT="Expand"></A></TD>
			<TH ALIGN=LEFT><FONT SIZE=2><A HREF="Missions.asp?ExpandLvl1=InvestSelect#Invest" TARGET="MainFrame" OnMouseOver="message('Expand'); return true">Investment Selection, Management, &amp; Evaluation</A></FONT></TH>
		
		</TR>
		<TR ALIGN=LEFT VALIGN=TOP>
		
			<TD><A NAME="Infra"> </A><A HREF="Missions.asp?ExpandLvl1=InfraUnder#Infra" TARGET="MainFrame" OnMouseOver="message('Expand'); return true"><IMG SRC="images/Expand.GIF" WIDTH="20" HEIGHT="20" BORDER=0 ALT="Expand"></A></TD>
			<TH ALIGN=LEFT><FONT SIZE=2><A HREF="Missions.asp?ExpandLvl1=InfraUnder#Infra" TARGET="MainFrame" OnMouseOver="message('Expand'); return true">Infrastructure Underpinnings</A></FONT></TH>
